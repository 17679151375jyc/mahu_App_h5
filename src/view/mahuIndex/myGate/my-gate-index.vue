...
<template>
  <div class="gate-wrapper">
    ...
    <div v-else style="width: 100%;padding: 2.6666vw;box-sizing: border-box;background-color: white">
    ...
    <!-- <div> -->
      ...
      :fade="true">-->
      <div v-if="myHomeInfoList.length>0" style="flex: 1;overflow-y:auto">
        ...
        <div class="base-horizontal-layout-space-between-item-center gate-index-details">
          <div class="base-horizontal-layout-center-item-center">
            ...
            <p class="base-text-title-large-666"
               style="font-weight: bold">{{mPropertyManagePlotName}}</p>
          </div>
          <div class="base-horizontal-layout-center-item-center gate-index-details-btn"
               @click="showAllDoorPop">
            <img :src="require('./icon-door.png')"
                 style="width: 3.7333vw;height: 4.1666vw;margin-right: 1.6vw"/>
            <p class="base-text-details-large-white but_text_line_height" style="font-weight: bold">开门</p>
          </div>
        </div>

        <div v-if="isShowVideo" @click="openVideo">
          <img :src="require('./icon-gate-video.png')" class="gate-index-video-box"/>
        </div>
...
export default {
  ...
  methods: {
    ...
    getMyHomeInfoList() {
      let self = this;
      self
        .$post("hArea", "/getMyAreaLists", { type: utils.returnTypeGate() })
        .then(res => {
    ...
    getPlotCamera() {
      let self = this;
      self.$post("camera", "/getPlotCamera", {}).then(res => {
