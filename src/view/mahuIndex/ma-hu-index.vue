...
<template>
  ...
  <div class="wrapper" ><!--style="margin-top: 8vw"-->
    ...
    <!--<return-head>-->
      <!--<div slot="title" class="ma-hu-index-title-middle">-->
        <!--<cube-tab-bar-->
          <!--v-model="selectedLabel"-->
          <!--inline-->
          <!--@click="clickHandler">-->
          <!--<cube-tab v-for="(item, index) in tabLabels" :label="item.label" :key="index">-->
            <!--&lt;!&ndash;&lt;!&ndash; name为icon的插槽 &ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;<i slot="icon" :class="item.label"></i>&ndash;&gt;-->
            <!--&lt;!&ndash; 默认插槽 &ndash;&gt;-->
            <!--<p v-if="index===2" style="width: 20vw;color: #cacaca;">{{item.label}}</p>-->
            <!--<p v-else style="width: 20vw;font-weight: bold !important;">{{item.label}}</p>-->
          <!--</cube-tab>-->
        <!--</cube-tab-bar>-->
      <!--</div>-->
    <!--</return-head>-->
    <div class="scroll-wrapper-head-and-bottom" style="top: 11.733333vw">
      <cube-slide
        ...
        <cube-slide-item v-if="isGate">
          ...
          <!--<div class="box3" :class="['base-horizontal-layout-general-item-center']" :style="styleaaa5">-->
            <!--<div class="box1" :style="styleaaa1" @click="aaa">-->
              <!--<p v-for="(item,index) in 20">11111111111111111</p>-->
            <!--</div>-->
            <!--<div class="box2" :style="styleaaa2" @click="bbb">-->
              <!--<p v-for="(item,index) in 20">22222222222222222</p>-->
            <!--</div>-->
          <!--</div>-->
          <!--<div class="box4" :class="['base-horizontal-layout-general-item-center']" :style="styleaaa6">-->
            <!--<div class="box1" :style="styleaaa3" @click="ccc">-->
              <!--<p v-for="(item,index) in 20">11111111111111111</p>-->
            <!--</div>-->
            <!--<div class="box2" :style="styleaaa4" @click="ddd">-->
              <!--<p v-for="(item,index) in 20">22222222222222222</p>-->
            <!--</div>-->
          <!--</div>-->
        </cube-slide-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions(
        ['setIndexPageTabIndex', 'setIsShowOtherPop', 'setMyHomeWork', 'setPushInfo', 'setIsShowDoorListGatePop']
      ),
      ...
      alertMsgMaintainOnClick(e) {//消息中点击申报维修
        ...
        this.alertMsgOrderTime = (e.alertMsgOrderTime || e.alertMsgOrderTime===0) ? e.alertMsgOrderTime*1000 : nowDate.getTime();
        this.nowTime =  e.alertMsgOrderTime===0 ? nowDate.getTime() : new Date(this.alertMsgOrderTime).getTime();
      ...
      toMyHomeWork(e) {
        this.$router.push({ path: "/ma-hu-index/work", query: { areaNumber: e.areaNumber }});
      },
      toCallSOS(e) {//点击SOS
        this.popPlainText = "出警后请保持手机畅通，安保会随时与您联系协助警情处理！";
          ...
          case 'plainText':
            switch (this.plainTextType) {
              ...
              case 'openDoorIn'://备城门开入口门
                self.$post("baseClient","/callOpenDoor",{
          ...
          case 'plainTextEnter'://前往评价
            if(this.homeIndex === -1) {
              ...
              if(this.alertMsgIndex === -1) {
                ...
                this.clearPoppupParameter();
                this.$router.push({ path: "/my-home/work/work-details", query: {messageType: this.alertMsgType}});
                this.setIsShowOtherPop(false);
                // utils.maskTabHide().then((e)=>{
                this.isPopShow = false;
                // });
